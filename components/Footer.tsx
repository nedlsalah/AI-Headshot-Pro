            ...
            <div className="max-w-screen-xl mx-auto flex justify-between items-center gap-4 px-4">
                ...
                <div className="hidden md:flex items-center gap-4 text-neutral-500 whitespace-nowrap">
                    ...
                    <p>
                        Created by{' '}
                        <a
                            href="https://www.instagram.com/nedlsalah/"
                            target="_blank"
                ...
                <div className="flex-grow flex justify-end items-center gap-4 sm:gap-6">
                    ...
                    <div className="flex items-center gap-4 sm:gap-6">
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="font-medium text-sm sm:text-base text-center text-black bg-yellow-400 py-2 px-4 rounded-sm transform transition-transform duration-200 hover:scale-105 hover:bg-yellow-300 shadow-[1px_1px_0px_1px_rgba(0,0,0,0.2)] whitespace-nowrap"
                        >
                            Apps on AI Studio
                        </a>
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="font-medium text-sm sm:text-base text-center text-white bg-white/10 backdrop-blur-sm border border-white/50 py-2 px-4 rounded-sm transform transition-transform duration-200 hover:scale-105 hover:bg-white hover:text-black whitespace-nowrap"
                        >
                            Chat with Gemini
                        </a>
                    </div>
