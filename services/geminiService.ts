...
/**
 * Creates a generic fallback prompt for a professional headshot.
 * @returns The fallback prompt string.
 */
function getFallbackPrompt(): string {
    return `Create a clear, professional headshot of the person in the image. The background should be a simple, blurred office setting. They should be wearing professional business attire. The final image must be a high-quality photograph.`;
}
...
/**
 * Generates an AI image from a source image and a prompt.
